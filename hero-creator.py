import random
dc_first = ("Bat","Super", "Wonder", "Green", "Aqua", "Cat", "Martian")
dc_last = ("man","woman","flash","lantern", "manhunter")
...
hero_action = (" got killed", " saved everyone", " defeated the villain", " commited taxfraud!")
say = random.sample(hero_action, 1)
...
def listToString(s): 
    ...
    for ele in s: 
        str1 += ele    
    return str1 
print(listToString(firstn + lastn + say ))
